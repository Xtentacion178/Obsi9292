...
local BaseURL = "https://github.com/deividcomsono/Obsidian/blob/main/Library.lua#L30"
...
function Library:CreateWindow(WindowInfo)
    ...
    function Window:AddTab(...)
        ...
        function Tab:AddTabbox(Info)
            ...
            function Tabbox:AddTab(Imageid)
                Imageid = Imageid or "rbxassetd://"
